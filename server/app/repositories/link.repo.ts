...
export const getUserLinksRepo = async (userId: number, options: GetUserLinksOptions = {}) => {
...
export const getLinkInfoByShortCodeRepo = async (shortCode: string, userId: number) => {
