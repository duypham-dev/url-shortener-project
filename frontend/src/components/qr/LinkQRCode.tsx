              ...
              <div className="flex flex-col gap-2">
                {qrCode ? (
                  qrCode.isActive ? (
                    <button
                      onClick={() => {
                        const svg = document.getElementById(`qr-svg-${link.short_code}`);
                        if (svg) {
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 border border-red-200 bg-red-50 text-red-600 rounded text-sm font-medium">
                      QR Code Locked
                    </div>
                  )
                ) : (
