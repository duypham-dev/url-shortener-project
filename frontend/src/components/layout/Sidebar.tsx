  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-12 w-8 h-8 border bg-white border-gray-200 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 shadow-sm z-10"
      >
